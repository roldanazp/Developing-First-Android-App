package com.udacity.shoestore.splashscreen
...
import com.udacity.shoestore.global.splashscreen.SplashScreenFragmentDirections
import com.udacity.shoestore.global.sharedpreferences.PreferencesHelper
import com.udacity.shoestore.splashscreen.databinding.FragmentSplashScreenBinding
...
class SplashScreenFragment : Fragment() {
    ...
    private fun getNavitationAction(): NavDirections {
        ...
        return if (PreferencesHelper.isUserLoggedIn && PreferencesHelper.isTutorialCompleted) {
            Timber.i("User visit te app for the first time")
